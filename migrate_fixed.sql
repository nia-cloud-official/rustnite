-- Fixed Migration script to add missing tables for enhanced features
...
-- Update badges table to support more requirement types
ALTER TABLE badges MODIFY COLUMN requirement_type ENUM(
    'lessons_completed', 
    'xp_earned', 
    'streak_days',
    'level_reached',
...
-- Clear existing badges and add new enhanced ones
DELETE FROM badges;
