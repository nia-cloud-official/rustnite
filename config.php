...
define("GITHUB_CLIENT_ID", "Ov23liJClnmcRcpRZkct"); // <-- SET YOUR GITHUB CLIENT ID
define("GITHUB_CLIENT_SECRET", "8328b80c2e33568fdaf09de8c193c3c4df153960"); // <-- SET YOUR GITHUB CLIENT SECRET
define(
    "GITHUB_REDIRECT_URI",
